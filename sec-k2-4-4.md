...
$A = \begin{bmatrix} a & b \\ c & d \end{bmatrix}$ (2)
...
${\widehat{V}}^{T}\widehat{V} = \left\lbrack v_{1} + v_{2} + \ldots + v_{n} \right\rbrack \times \begin{bmatrix} v_{1} \\ v_{2} \\ \vdots \\ v_{n} \end{bmatrix} = \left\lbrack v_{1}^{2} + v_{2}^{2} + \ldots + v_{n}^{2} \right\rbrack$ (6)
Denna ekvation kan vi skriva om genom att använda definitionen av $\widehat{V}$ från ekvation 2:
${\widehat{V}}^{T}\widehat{V} = \left( Y - X\widehat{B} \right)\left( Y - X\widehat{B} \right)$ (7)$ $
...
${\widehat{V}}^{T}\widehat{V} = Y^{T}Y - 2{\widehat{B}}^{T}X^{T}Y + {\widehat{B}}^{T}X^{T}X\widehat{B}$ (8)
...
$\min_{\widehat{B}}\left( {\widehat{V}}^{T}\widehat{V} \right)$ (9)
...
$\frac{\partial{\widehat{V}}^{T}\widehat{V}}{\partial\widehat{B}} = - 2X^{T}Y + 2X^{T}X\widehat{B} = 0$ (10)
...
$\left( X^{T}X \right)^{- 1}\left( X^{T}X \right)\widehat{B} = \left( X^{T}X \right)^{- 1}X^{T}Y$ (12)
