...
\begin{align}
\text{Sparbelopp efter år 1} &= 5\ 000 * 1,02 \\
                              &= 5\ 000 * 1 + 5\ 000 * 0,02 \\
                              &= 5\ 000 + 100 \\
                              &= 5\ 100
\end{align}
...
Ränta per månad:  $0,12/12\ = 0,01 = 1\%$ Säg nu att du använder kreditkortet för att handla för 20 000 kr och väntar 3 månader med att betala. Hur mycket blir räntan?
...
Räntekostnaden för att låna i tre månader på kreditkortet blir i detta fall:\ $20\ 606,02\ --20\ 000 = 606,02$ kr.
