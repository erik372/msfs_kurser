...
Ett annat exempel är en variabel som anger om en rad i en tabell innehåller information om en man eller en kvinna, varpå variabeln kan anta värdet 0 för det ena könet och 1 för det andra könet. En förklarande variabel i en regressionsmodell som endast antar värdena 0 eller 1 kallas för *dummyvariabel* eller *indikatorvariabel, kategorisk variabel*. Namnet \"dummyvariabel\" kommer från engelskans \"dummy\" som betyder \"ersättning\" eller \"ställföreträdare\". Vi ersätter kvalitativa kategorier (man/kvinna) med siffror (0/1) så att vi kan använda dem i regressionsanalys.
...
::: {.fig-caption}
Beskrivning: Data från [Kolada](http://www.kolada.se). Inkomst anges i 1 000-tals kronor, medianvärden per kommun och grupp.
...
<tr>
<th>Kommun</th>
<th style="text-align: center;">\(W_{i}\)</th>
<th style="text-align: center;">\(G_{i}\)</th>
<th style="text-align: center;">\(W_{i} - \overline{W_{i}}\)</th>
<th style="text-align: center;">\(G_{i} - \overline{G_{i}}\)</th>
<th style="text-align: center;">\(\left( G_{i} - \overline{G_{i}} \right)^{2}\)</th>
</tr>
</thead>
<tbody>
<tr>
...
::: {.fig-caption}
Beskrivning: Samma data som i tabell 1 och några beräkningar.
:::
...
::: {.fig-caption}
Beskrivning: Regressionslinjen lutar nedåt vilket indikerar en negativ samvariation. I variabeln G har kvinnor värdet 1 och män värdet 0. Eftersom kvinnor har lägre inkomst i genomsnitt än män, uppstår en negativ samvariation.
:::
...
<th style="text-align: center;">\(K_{\text{Mörbylånga}}\)</th>
<th style="text-align: center;">\(K_{\text{Oskarshamn}}\)</th>
</tr>
</thead>
<tbody>
<tr>
...
::: {.fig-caption}
Beskrivning: Data från [Kolada](http://www.kolada.se). Inkomst anges i 1 000-tals kronor, medianvärden per kommun.
:::
...
::: {.next-section-link}
[→ Nästa avsnitt: **Konstanthålla**](k2-4-3.html)
:::
