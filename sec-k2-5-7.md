...
där $\ln Y_{t}$ är logaritmerad BNP år $t,c$ och $d$ är koefficienterna och $U_{t}$ är feltermen.
...
::: {.fig-caption}
Beskrivning: Data från [www.historia.se](http://www.historia.se).
:::


**Figur 1: BNP och logaritmerad BNP**

![](img/k2-5-7-image1.png)

::: {.fig-caption}
Beskrivning: Data från [www.historia.se](http://www.historia.se), samma som i tabell 1.
:::
...
![](img/k2-5-7-image3.png)


::: {.fig-caption}
Beskrivning: De fyra diagrammen beskriver påhittade data presenterade i [Anscombe 1973](https://www.lithoguru.com/scientist/statistics/Anscombe_Graphs%20in%20Statistical%20Analysis_1973.pdf).
:::
