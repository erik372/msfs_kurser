...
under villkoret $C \leq w(T - L)$ Detta löser vi genom att ställa upp Lagrangefunktionen:


$$\mathcal{L}(C,L):\ C^{\frac{1}{2}}L^{\frac{1}{2}} + \lambda(wT - wL - C) \tag{4}$$

Vi tar derivatan av $\mathcal{L}$ med hänsyn till C respektive L:
$$\mathcal{L}_{C}':\frac{1}{2}C^{- \frac{1}{2}}L^{\frac{1}{2}} - \lambda \tag{5}$$
