...
### Ett påhittat land
Vi börjar med att tänka oss att vi har ett samhälle utan skatter. *Matematiken i detta avsnitt är lånad och inspirerad av [Lundberg (2017)](https://www.lisdatacenter.org/wps/liswps/711.pdf). Tack till Jacob Lundberg som kommenterade ett tidigare utkast på denna text. Återstående misstag är tyvärr mina egna.*
...
![En bild som visar text, diagram, Graf, linje Automatiskt genererad beskrivning](img/k1-4-3-image1.png)
