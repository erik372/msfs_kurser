...
### Avsnitt 4.1: Regressionsanalys med tre variabler {#avsnitt-4.1-regressionsanalys-med-tre-variabler .title}

### Pushtext

Avsnittet introducerar regressionsanalys med tre variabler: en förklarad variabel och två förklarande variabler. Detta leder till lite krångligare beräkningar men viktiga insikter om vetenskapliga metoder och logik.
...
### Avsnitt 4.2: Faktorvariabler {#avsnitt-4.2-faktorvariabler .title}

### Pushtext

Avsnittet introducerar faktorvariabler, även kallat kategoriska variabler, som antar diskreta värden till exempel för att beskriva kategorier.
...
### Avsnitt 4.3: Konstanthålla {#avsnitt-4.3-konstanthålla .title}

### Pushtext

I detta avsnitt ska vi gå igenom vad det innebär när vi konstanthåller andra fenomen i en regressionsanalys. Vi illustrerar detta och några saker vi gått igenom tidigare med ytterligare ett exempel.
...
### Avsnitt 4.4: Regression med matriser {#avsnitt-4.4-regression-med-matriser .title}

### Pushtext

I detta avsnitt introducerar vi hur vi kan använda regressionsanalys och minstakvadratmetoden med matriser. Matriser gör det enklare att beskriva beräkningar och logik för en regressionsmodell med valfritt antal variabler och koefficienter.
...
### Avsnitt 4.5: Estimera med matriser {#avsnitt-4.5-estimera-med-matriser .title}

### Pushtext

Avsnittet går igenom några praktiska exempel på regressionsmodeller som vi estimerar med matriser.
...
### Kapitel 4.6: Regressionsanalys med interaktionseffekt {#kapitel-4.6-regressionsanalys-med-interaktionseffekt .title}

### Pushtext

I detta avsnitt går vi igenom regressionsanalys med interaktionseffekter. Interaktionseffekt syftar på när vi kombinerar två förklarande variabler för att uppskatta hur en variabel kan ha olika effekter, beroende på en annan variabel.
...
### Avsnitt 4.7: Räkna på orsak och verkan {#avsnitt-4.7-räkna-på-orsak-och-verkan .title}

### Pushtext

I detta avsnitt ska vi gå in på hur vi kan använda regressionsanalys för att räkna på effekten av en orsak.
