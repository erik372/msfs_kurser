...
### Teori
Säg nu att Kim (från [avsnitt 3.2](k1-3-2.html))har hittat en partner och vill arbeta för att få sin relation att fungera. Men Kim vill inte lägga ned mer arbete på relationen än vad Kims partner gör. Partnern känner detsamma och vill inte heller engagera sig om inte Kim gör det. Detta kan vi beskriva med hjälp av ett ickelinjärt ekvationssystem:

$$\left\{ \begin{array}{r} K = P^{2} + 0{,}1 \\ P = K^{2} + 0{,}1 \end{array} \right.,\quad K,P \in [0,1] \tag{1}$$
...
$$P - 0{,}1 = P^{4} + 2 \cdot 0{,}1 \cdot P^{2} + (0{,}1)^{2}$$

När vi kvadrerar båda sidor av en ekvation kan vi få falska rötter. Därför måste alla lösningar verifieras genom att sättas tillbaka i originalekvationen. Vi har nu fått följande fjärdegradspolynom:
...
$$P = 0: \quad 0 + 0 - 0 + 0{,}11 = 0{,}11 \neq 0 \tag{4}$$

$$P = \tfrac{1}{2}: \quad \left( \tfrac{1}{2} \right)^{4} + 0{,}2\left( \tfrac{1}{2} \right)^{2} - \tfrac{1}{2} + 0{,}11 = -0{,}2775 \neq 0 \tag{5}$$

$$P = 1: \quad 1 + 0{,}2 - 1 + 0{,}11 = 0{,}31 \neq 0 \tag{6}$$

Ingen av dessa var en lösning, men notera hur resultaten för polynomet är positivt för $P = 0$ och $P = 1$, men negativt för $P = \frac{1}{2}$. Detta innebär att det bör finnas ett eller flera värden för P mellan dessa värden som resulterar i att polynomet blir lika med 0. Det bör finnas en lösning för P mellan 0 och $\frac{1}{2}$ samt ytterligare en lösning mellan $\frac{1}{2}$ och 1.
