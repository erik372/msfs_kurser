...
$$\text{lycka}_{1} = 80 - 2*\text{dejt}_{1} - 50 \tag{1}$$
...
$$\text{lycka}_{2} = 80 - 22*\text{dejt}_{2} \tag{2}$$

Detta ger oss ett linjärt ekvationssystem med två ekvationer:


$$\left\{ \begin{array}{r} \text{lycka}_{1} = 30 - 2*\text{dejt}_{1} \\ \text{lycka}_{2} = 80 - 22*\text{dejt}_{2} \end{array} \right.\  \tag{3}$$
...
\begin{align}
\text{lycka}_{1}^{*} &= 30 - 2*2{,}5 = 25 \tag{6}\\
...
![](img/k1-3-2-image1.png)


::: {.fig-caption}
Beskrivning: Den gröna linjen beskriver dejtingstrategi 1, med dejtingappen. Den rosa linjen beskriver dejtingstrategi 2, träffa kompisens kompisar. Vid 2,5 dejter möts de två linjerna, varpå Kims lycka är nere på 25.
:::
...
$$\left\{ \begin{array}{r} \text{lycka} = m - ad_{1} - b \\ \text{lycka} = m - cd_{2} \end{array} \right.\  \tag{7}$$
...
Detta låter oss beskriva hur de olika variablerna hänger ihop och vad som krävs för att $d^{*}$ ska anta ett positivt värde. Givet att $b > 0$ måste $c > a$. Det vill säga, för att strategierna ska kunna betraktas som likvärdiga vid någon mängd dejter överhuvudtaget, så krävs, givet att appen minskar lyckan (konstant *b*), att lyckominskningen för att gå på dejt med kompisens kompis (*c*) måste vara större än lyckominskningen per dejt via appen (*a*).
