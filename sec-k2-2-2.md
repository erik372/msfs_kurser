...
Eftersom $a$ inte påverkas av summeringen kan vi flytta ut alla $a^{2}$: \begin{align}
...
&= a^{2}var(x)
\end{align} För standardavvikelse får vi:
...
&= \|a\|s_{x}
\end{align} där $\|a\|$ är absolutbeloppet av konstanten $a$.
