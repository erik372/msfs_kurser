...
$$\text{BNP-tillväxt} = \frac{y_{t} - y_{t-1}}{y_{t-1}}$$
...
::: {.fig-caption}
Beskrivning: Data från SCB. BNP deflaterad med BNP-deflatorn, omräknad till 2019 års priser.
:::
...
::: {.fig-caption}
Beskrivning: Data från [www.historia.se](http://www.historia.se). Ln(BNP) är naturliga logaritmen av talen i kolumnen med BNP räknat i miljoner kr.
:::
