...
$cov(x,y) = \left( \frac{1}{n - 1} \right)\sum_{i}^{}{\left( x_{i} - \overline{x} \right)\left( y_{i} - \overline{y} \right)} = \left( \frac{1}{3} \right) \times 5 = \frac{5}{3}$ (4)
...
$r_{xy} = \frac{cov(x,y)}{s_{x}s_{y}}$ (6)
...
$r_{xy} = \frac{cov(x,y)}{s_{x}s_{y}}$ (7)
...
$r_{xy} = \frac{cov(x,y)}{s_{x}s_{y}} \approx \frac{\frac{5}{3}}{\left( + \sqrt{\frac{10}{3}} \right)\left( + \sqrt{\frac{5}{3}} \right)} \approx 0,71$ (8)
